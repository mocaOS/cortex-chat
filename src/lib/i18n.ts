const translations = {
  en: {
    ...
    sourcesFoundSoFar: "Found {count} sources so far",
    thinking: "Thinking",
    steps: "steps",
    ...
    soulStatus: "Status",
    soulEnabled: "Active",
    soulDisabled: "Disabled",
    soulRemove: "Remove",
    soulRestore: "Restore",
    soulDisable: "Disable",
    soulVisibility: "Visibility",
  ...
  de: {
    ...
    docs: "Dok.",
    docsCount: "{count} Dok.",
    sourcesFoundSoFar: "Bisher {count} Quellen gefunden",
    thinking: "Denkt nach",
    steps: "Schritte",
    ...
    soulStatus: "Status",
    soulEnabled: "Aktiv",
    soulDisabled: "Deaktiviert",
    soulRemove: "Entfernen",
    soulRestore: "Wiederherstellen",
    soulDisable: "Deaktivieren",
    soulVisibility: "Sichtbarkeit",
